...
\begin{figure}[t]
    ...
    \begin{tabular}{m{0.28\textwidth} m{0.28\textwidth} m{0.28\textwidth}}
        \centering \textbf{Head-side targets} \\
        \centering {\small Partially image-available} \\
        \centering \fbox{\parbox[c][1.0cm][c]{0.78\linewidth}{\centering \texttt{head\_has\_img}}} \\
        \centering \fbox{\parbox[c][1.0cm][c]{0.78\linewidth}{\centering \texttt{head\_no\_img}}}
        &
        \centering \textbf{Target position is intrinsically entangled} \\
        \centering \textbf{with modality availability} \\
        \\
        \centering {\small Bidirectional evaluation} \\
        \centering {\small becomes inherently asymmetric}
        &
        \centering \textbf{Tail-side targets} \\
        \centering {\small Fully image-unavailable} \\
        \centering \fbox{\parbox[c][2.4cm][c]{0.78\linewidth}{\centering \texttt{tail\_no\_img}}}
    \end{tabular}
