...
\small
\begin{tabular}{p{0.22\textwidth}p{0.11\textwidth}p{0.19\textwidth}p{0.18\textwidth}cp{0.18\textwidth}}
\toprule
...
Fourth, the main routing conclusions are based primarily on MRR and paired bootstrap delta-MRR. Hit-based routing exports are treated as auxiliary rather than final evidence, and the separate oracle-gap decomposition export requires further verification before it should be treated as final quantitative evidence. For this reason, the strongest claims of the paper are grounded primarily in the protocol diagnosis, direct MRR-based clean-routing comparisons, and the updated paired-bootstrap comparisons for the strongest clean policies.
